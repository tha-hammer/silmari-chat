 ...
 *
 * Handles environment variable expansion for portable AAI configuration.
...
/**
 * Get the AAI directory (expanded)
 * Priority: AAI_DIR env var (expanded) → ~/.claude
 */
export function getPaiDir(): string {
  const envPaiDir = process.env.AAI_DIR;
...
/**
 * Get a path relative to AAI_DIR
 */
