...
**Standard arc (situation-complication-resolution):**
1. **Situation** — What is the current state? Set the scene.
2. **Complication** — What changed or what's the problem? Create tension.
3. **Resolution** — How do we solve it? Release the tension.
...
| "Customer Feedback" | "93% of teams ship faster with [your product]" |
