...
Comprehensive list of A/B tests and experiments organized by page type. Use this as a menu when generating test ideas in Step 4 of the audit — pick experiments that address the specific issues found in the audit, don't just list generic tests.
