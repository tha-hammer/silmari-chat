...
`~/.claude/AAI-USER/SKILLCUSTOMIZATIONS/Research/`
...
- Marketing research / voice-of-customer / review mining (Reddit + 100+ reviews → keyword frequency table) -> `Workflows/MarketingResearch.md`
