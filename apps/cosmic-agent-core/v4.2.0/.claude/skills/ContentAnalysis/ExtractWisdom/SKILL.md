...
`~/.claude/AAI-USER/SKILLCUSTOMIZATIONS/ExtractWisdom/`
...
**Canonical voice reference: `AAI/USER/WRITINGSTYLE.md`** — read this file for the full voice definition. The bullets should sound like {PRINCIPAL.NAME} telling a friend about it over coffee. Not compressed info nuggets. Not clever one-liners. Actual spoken observations.
