...
This directory contains social media Open Source Intelligence (OSINT) tools for the AAI webassessment skill. These tools enable username tracking, Instagram analysis, and Twitter/X intelligence gathering for penetration testing and social media reconnaissance.
...
These tools are designed to be used by the AAI webassessment skill for social media reconnaissance during security assessments. The skill can:
