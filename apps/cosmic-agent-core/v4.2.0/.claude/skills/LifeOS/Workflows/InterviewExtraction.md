...
- "extract content"
- "extract LifeOS content"
- "extract interviews"
- "analyze interviews"
- Running LifeOS skill on a directory containing interviews
...
This workflow is a component of the LifeOS skill and can be:
- Invoked directly via trigger phrases
- Called as part of broader LifeOS analysis
- Combined with other LifeOS workflows for comprehensive assessment

The extracted categories align with LifeOS methodology for organizational analysis, particularly:
