// LifeOS Report Data Structure
// This file is auto-generated from LifeOS analysis
...
// Default placeholder data - replace with actual LifeOS analysis
export const reportData: ReportData = {
  ...
  executiveSummary: {
    context: "This report presents findings from our comprehensive LifeOS analysis of [CLIENT], conducted to assess strategic readiness and identify transformation opportunities.",
    methodology: {
  ...
  situationAssessment: {
    currentState: "Replace with current state analysis from LifeOS",
  ...
  findings: [
    ...
    // Add more findings from LifeOS analysis
  ],

  riskAnalysis: {
    existentialRisks: [
      "Replace with existential risks from LifeOS Stakes section",
    ],
    competitiveThreats: [
  ...
  recommendations: [
    ...
    // Add more recommendations from LifeOS analysis
  ],

  targetState: {
    description: "Replace with the vision description from LifeOS",
    keyCapabilities: [
