...
- **AAI/CONSTITUTION.md** - Constitutional principles (Article IX)
...
## Core Testing Principles (from AAI)

These are already loaded via AAI or Development skill - reference, don't duplicate:
