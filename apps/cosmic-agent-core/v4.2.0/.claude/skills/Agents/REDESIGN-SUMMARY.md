...
- ❌ Duplicated AAI content (stack preferences, coding standards)
...
- ✅ Supplements AAI without redundancy
...
- **AAI/CONSTITUTION.md** - Foundational principles
- **AAI/CoreStack.md** - Stack preferences
...
1. **No Duplication**: AAI already provides constitutional principles, stack preferences, etc.
...
4. **Supplements AAI**: Adds agent-specific context without replacing base knowledge
