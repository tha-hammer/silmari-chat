...
### Core Foundations
- **AAI/CoreStack.md** - Stack preferences (TypeScript > Python!) and tooling
...
## Key Research Principles (from AAI)

These are already loaded via AAI or Research skill - reference, don't duplicate:
