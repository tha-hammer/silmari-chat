...
> Canonical identity schema for all AAI agents — built-in and custom.
...
[Standard AAI output format with sections:
...
| Lifecycle | Permanent, ships with AAI | User-managed (create/delete) |
