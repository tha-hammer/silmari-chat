...
**Canonical source of truth for all AAI agent personality definitions.**

This file defines the character, voice settings, backstories, and personality traits for all agents in the AAI system. The voice server reads this configuration to deliver personality-driven voice communication.

## Hybrid Agent Model

AAI uses a **hybrid agent system** that combines:
...
- **v1.3.0** (2025-11-16): Centralized in AAI, increased expressiveness for all agents
