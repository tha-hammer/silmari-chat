...
### Core Foundations
- **AAI/CoreStack.md** - Stack preferences and tooling
- **AAI/CONSTITUTION.md** - Constitutional principles
...
## Key Engineering Principles (from AAI)

These are already loaded via AAI - reference, don't duplicate:
