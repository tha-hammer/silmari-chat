...
The cover page MUST include {YOUR_BUSINESS_NAME} branding: your logo, "PRAXOS Assessment" label, and "{YOUR_BUSINESS_NAME} CONSULTING" in all caps. The footer on every page MUST include "{YOUR_BUSINESS_NAME} Consulting".

```html
<div class="cover">
  <div class="classification">CONFIDENTIAL</div>
  <img class="logo" src="file:///path/to/your-logo.png" alt="{YOUR_BUSINESS_NAME}" />
  <div class="brand-label">PRAXOS Assessment</div>
