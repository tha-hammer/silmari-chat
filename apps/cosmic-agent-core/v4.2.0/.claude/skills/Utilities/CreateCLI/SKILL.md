...
`~/.claude/AAI-USER/SKILLCUSTOMIZATIONS/CreateCLI/`
...
## 🏗️ INTEGRATION WITH AAI

### Technology Stack Alignment

Generated CLIs follow AAI standards:
...
- `${PROJECTS_DIR}/AAI/Examples/clis/` - Example CLIs (PUBLIC repo)
...
ghcli issues create --repo sai --title "Bug fix"
...
### 5. Integration
- ✅ Follows AAI tech stack (Bun, TypeScript)
- ✅ CLI-First Architecture principles
- ✅ Deterministic output (JSON)
