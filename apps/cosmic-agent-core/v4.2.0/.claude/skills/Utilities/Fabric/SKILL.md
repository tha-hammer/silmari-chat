...
`~/.claude/AAI-USER/SKILLCUSTOMIZATIONS/Fabric/`
...
Instead of calling `fabric -p pattern_name`, AAI executes patterns natively:
...
### 2026-01-18
- Initial skill creation (extracted from AAI/Tools/fabric)
