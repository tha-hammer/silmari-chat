...
`~/.claude/AAI-USER/SKILLCUSTOMIZATIONS/Prompting/`
...
The templating system eliminated **~35,000 tokens (65% reduction)** across AAI:
...
**Philosophy:** Prompts that write prompts. Structure is code, content is data. Meta-prompting enables dynamic composition where the same template with different data generates specialized agents, workflows, and evaluation frameworks. This is core AAI DNA - programmatic prompt generation at scale.
