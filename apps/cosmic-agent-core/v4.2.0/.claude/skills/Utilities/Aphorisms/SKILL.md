...
`~/.claude/AAI-USER/SKILLCUSTOMIZATIONS/Aphorisms/`
...
- **Author** - Thinkers aligned with PRAXOS philosophy
...
2. **Thinkers Aligned with PRAXOS** - Sections for Hitchens, Deutsch, Harris, Spinoza, Feynman (to be populated)
...
- Focus on PRAXOS-aligned themes
...
All five thinkers align with PRAXOS themes of **wisdom, rationality, truth-seeking, and human flourishing:**
...
4. **PRAXOS alignment** - Focus on wisdom, rationality, truth-seeking
...
4. **Expanded thinker research** - Add more philosophers aligned with PRAXOS
