/**
 * AAI Installer v4.0 — Step Definitions
...
export const STEPS: StepDefinition[] = [
  {
    ...
    description: "Detect operating system, installed tools, and existing AAI installation",
    number: 1,
    required: true,
    dependsOn: [],
  },
  ...
  },
  {
    id: "repository",
    name: "AAI Repository",
    description: "Clone or update the AAI repository into ~/.claude",
    number: 5,
    required: true,
    dependsOn: ["identity"],
  },
