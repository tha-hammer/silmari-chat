#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════
#  AAI Installer v4.0 — Bootstrap Script
...
echo -e "${STEEL}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓${RESET}"
echo ""
echo -e "                      ${NAVY}P${RESET}${BLUE}A${RESET}${LIGHT_BLUE}I${RESET} ${STEEL}|${RESET} ${GRAY}Agent Assistant Infrastructure${RESET}"
echo ""
echo -e "                     ${ITALIC}${LIGHT_BLUE}\"Maximizing human potential...\"${RESET}"
echo ""
echo ""
...
echo -e "           ${NAVY}████${RESET}        ${NAVY}████${RESET}${LIGHT_BLUE}████${RESET}   ${SEP}  ${NAVY}⬢${RESET}  ${GRAY}AAI${RESET}       ${SILVER}v4.0.3${RESET}"
...
echo ""
echo ""
echo -e "                       ${STEEL}→${RESET} ${BLUE}github.com/hackerman-cosmic/Agent-Assistant-Infrastructure${RESET}"
echo ""
echo -e "${STEEL}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${RESET}"
echo ""
...
# ─── Launch Installer ────────────────────────────────────
# Resolve AAI-Install directory (may be sibling or child of script location)
INSTALLER_DIR=""
if [ -d "$SCRIPT_DIR/AAI-Install" ]; then
  INSTALLER_DIR="$SCRIPT_DIR/AAI-Install"
elif [ -f "$SCRIPT_DIR/main.ts" ]; then
  INSTALLER_DIR="$SCRIPT_DIR"
else
  error "Cannot find AAI-Install directory. Expected at: $SCRIPT_DIR/AAI-Install/"
  exit 1
fi
