...
Local flow definitions are tracked in `~/.claude/AAI/FLOWS/flow-index.json`:
...
|------|--------|--------|---------|
| 2026-02-03 | Created document | {DAIDENTITY.NAME} | AAISYSTEMARCHITECTURE.md, ACTIONS.md, PIPELINES.md |
