...
Each action is a flat directory under `~/.claude/AAI/ACTIONS/`:
...
mkdir ~/.claude/AAI/USER/ACTIONS/A_YOUR_ACTION
```
...
- **Pipelines:** `~/.claude/AAI/PIPELINES.md`
- **Flows:** `~/.claude/AAI/FLOWS.md`
- **Architecture:** `~/.claude/AAI/AAISYSTEMARCHITECTURE.md`
- **Personal Actions:** `~/.claude/AAI/USER/ACTIONS/`
...
|------|--------|--------|---------|
| 2026-02-03 | Created document | {DAIDENTITY.NAME} | AAISYSTEMARCHITECTURE.md, PIPELINES.md, FLOWS.md |
