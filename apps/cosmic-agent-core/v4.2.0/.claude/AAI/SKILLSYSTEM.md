...
**The MANDATORY configuration system for ALL AAI skills.**

---

## THIS IS THE AUTHORITATIVE SOURCE

This document defines the **required structure** for every skill in the AAI system.
...
### System Skills (Shareable via AAI Packs)
- Use **TitleCase** naming: `Browser`, `Research`, `Development`
- Contain NO personal data (contacts, API keys, team members)
- Reference `~/.claude/AAI/USER/` for any personalization
- Can be exported to the public AAI repository
...
- Will NEVER be pushed to public AAI
...
- They are automatically excluded from AAI pack exports

**Pattern for Personalization in System Skills:**
System skills should reference AAI/USER files for personal data:
```markdown
## Configuration
Personal configuration loaded from:
- `~/.claude/AAI/USER/CONTACTS.md` - Contact information
- `~/.claude/AAI/USER/TECHSTACKPREFERENCES.md` - Tech preferences
```
...
`~/.claude/AAI/USER/SKILLCUSTOMIZATIONS/{SkillName}/`
...
```
~/.claude/AAI/USER/SKILLCUSTOMIZATIONS/
...
1. **Create directory**: `mkdir -p ~/.claude/AAI/USER/SKILLCUSTOMIZATIONS/SkillName`
...
**Full documentation:** `~/.claude/AAI/THENOTIFICATIONSYSTEM.md`
...
- ❌ Pure utility wrappers (use AAI/TOOLS.md instead)
...
**See:** `~/.claude/AAI/CLIFIRSTARCHITECTURE.md` (Workflow-to-Tool Integration section)
...
**See:** `~/.claude/AAI/CLIFIRSTARCHITECTURE.md` (Configuration Flags section) for full documentation
