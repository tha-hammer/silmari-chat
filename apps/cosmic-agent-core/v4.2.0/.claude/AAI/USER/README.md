...
This directory contains your personal AAI configuration. Everything here is **yours** — AAI never overwrites user files during upgrades.

## Identity Files

Create these in this directory to personalize your AAI system:
...
| `LifeOS/` | Life OS — goals, beliefs, challenges, books, wisdom |
...
1. Start with `ABOUTME.md` — tell AAI who you are
