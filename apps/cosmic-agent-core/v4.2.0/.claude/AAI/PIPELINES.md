...
Local pipeline definitions live in `~/.claude/AAI/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md`

```markdown
# [Pipeline_Name] Pipeline

**Purpose:** [One sentence describing what this pipeline achieves]
**Domain:** [e.g., Blog, Newsletter, Art, AAI]
**Version:** 1.0
...
**Examples:** `Blog_Publish-Post`, `Newsletter_Full-Cycle`, `AAI_Release`
...
```bash
mkdir -p ~/.claude/AAI/PIPELINES/[Domain]_[Pipeline-Name]
# PIPELINE-TEMPLATE.md is planned but not yet created
# For now, copy an existing pipeline and modify it
cp ~/.claude/AAI/PIPELINES/Blog_Publish-Post/PIPELINE.md ~/.claude/AAI/PIPELINES/[Domain]_[Pipeline-Name]/PIPELINE.md
```
...
- **Actions:** `~/.claude/AAI/ACTIONS.md`
- **Flows:** `~/.claude/AAI/FLOWS.md`
- **Architecture:** `~/.claude/AAI/AAISYSTEMARCHITECTURE.md`
- **Detailed README:** `~/.claude/AAI/PIPELINES/README.md`
