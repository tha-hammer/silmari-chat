# AAI PRD Format Specification v2.0
...
Google Design Docs, Amazon 6-pagers, Shape Up pitches, and 48 production AAI PRDs.
...
- **Reference file pattern**: This spec lives at `~/.claude/AAI/PRDFORMAT.md`, not inline in CLAUDE.md. Saves ~2,500 tokens/response.
