...
/**
 * ============================================================================
 * AAI ACTIONS v2 - Shareable Action Types
 * ============================================================================
 *
...
export interface ActionCapabilities {
  ...
  /** Shell command execution. `exitCode`/`signal` match the ActionContext
   *  ShellResult contract every action reads; `code` is a legacy alias. */
  shell?: (
    cmd: string,
  ) => Promise<{
    stdout: string;
...
export interface ActionContext {
  ...
  /** Optional progress observer for long-running actions. */
