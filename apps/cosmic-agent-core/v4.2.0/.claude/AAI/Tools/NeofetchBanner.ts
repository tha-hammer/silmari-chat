...
/**
 * NeofetchBanner - AAI System Banner in Neofetch Style
 *
 * Layout:
 *   LEFT:   Isometric AAI cube logo (ASCII/Braille art)
 *   RIGHT:  System stats as key-value pairs
 *   BOTTOM: AAI header, quote, sentiment histogram, AAI name, GitHub URL
 *
...
// ═══════════════════════════════════════════════════════════════════════
// AAI Isometric Cube Logo - ASCII Art with P, A, I on faces
// ═══════════════════════════════════════════════════════════════════════
...
// Isometric AAI cube using box drawing and blocks
...
// Enhanced braille-based AAI logo for smaller terminals
const AAI_BRAILLE_LOGO = [
  "⣿⣿⣿⣛⣛⣛⣿⣿⣿⣿⣛⣛⣛⣛⣿⣿",
  "⣿⣿⣛⣛⣿⣿⣛⣿⣿⣛⣛⣿⣿⣿⣛⣿",
  "⣿⣛⣛⣿⣿⣿⣿⣛⣛⣿⣿⣿⣿⣿⣛⣛",
  "⣛⣛⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣛",
...
// ═══════════════════════════════════════════════════════════════════════
// AAI Cube Logo with Gradient Coloring
// ═══════════════════════════════════════════════════════════════════════
...
function createNeofetchBanner(): string {
  ...
  // ─────────────────────────────────────────────────────────────────
  // LEFT: AAI Logo | RIGHT: System Stats
  // ─────────────────────────────────────────────────────────────────

  // Use ASCII cube logo for clear rendering with P, A, I visible
  const logo = colorLogo(AAI_CUBE_ASCII);
  ...
  // AAI Header
  const paiHeader = `${BOLD}${nc}P${RESET}${BOLD}${np}A${RESET}${BOLD}${c}I${RESET} ${f}|${RESET} ${t}Agent Assistant Infrastructure${RESET}`;
  lines.push(center(paiHeader, width));
  lines.push("");

  // Quote
  const quote = `${s}"Maximizing human potential..."${RESET}`;
  ...
  const githubUrl = `${f}${RETICLE.topLeft}${RESET} ${tl}github.com/hackerman-cosmic/Agent-Assistant-Infrastructure${RESET} ${f}${RETICLE.topRight}${RESET}`;
...
function createCompactBanner(): string {
  ...
  lines.push(`${f}${RETICLE.bottomLeft}${s}AAI${f}${RETICLE.bottomRight}${RESET}`);
