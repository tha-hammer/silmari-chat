...
/**
 * ============================================================================
 * THE ALGORITHM CLI — Run the AAI Algorithm in Loop or Interactive mode
 * ============================================================================
 *
...
const BASE_DIR = process.env.AAI_DIR || join(HOME, ".claude");
...
function printHelp(): void {
  console.log(`
\x1b[36mTHE ALGORITHM\x1b[0m — AAI Algorithm Runner (v1.0.0)
