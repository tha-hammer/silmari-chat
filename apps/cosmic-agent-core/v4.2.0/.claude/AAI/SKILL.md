<!-- AAI SKILL.md — Core skill definition for Agent Assistant Infrastructure -->
---
name: AAI
description: Agent Assistant Infrastructure core. The authoritative reference for how AAI works.
---

# Intro to AAI

**The** AAI system is designed to magnify human capabilities. It is a general problem-solving system that uses the AAI Algorithm.
...
# The Algorithm (v3.7.0 | github.com/cosmic-hq/TheAlgorithm)
...
```
♻︎ Entering the AAI ALGORITHM… (v3.7.0 | github.com/cosmic-hq/TheAlgorithm) ═════════════

🗒️ TASK: [8 word description]

`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"fTtv3eikoepIosk8dTZ5","message": "Entering the AAI Algorithm Observe phase"}'`
...
Critical AAI documentation organized by domain. Load on-demand based on context.

| Domain | Path | Purpose |
|--------|------|---------|
| **System Architecture** | `SYSTEM/AAISYSTEMARCHITECTURE.md` | Core AAI design and principles |
...
| **Agent System** | `SYSTEM/AAIAGENTSYSTEM.md` | Agent types, spawning, delegation |
...
| "LifeOS", "life goals", "goals", "challenges" | `USER/LifeOS/PROJECTS.md` | Life goals, challenges, predictions (LifeOS Life System) |
