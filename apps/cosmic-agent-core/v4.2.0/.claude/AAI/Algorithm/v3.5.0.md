...
```
♻︎ Entering the AAI ALGORITHM… (v3.5.0) ═════════════
...
- Write PRD.md with Write tool — include YAML frontmatter (task, slug, effort, phase, progress, mode, started, updated) + sections (Context, Criteria, Decisions, Verification) per `~/.claude/AAI/PRDFORMAT.md`
