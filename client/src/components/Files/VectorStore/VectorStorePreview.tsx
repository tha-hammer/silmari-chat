      ...
      <div className="flex flex-col justify-between md:flex-row">
        <div className="flex flex-col">
          <b className="hidden text-base md:text-lg lg:block lg:text-xl">
            {localize('com_files_vector_store_header')}
          </b>
        ...
        <div className="mt-3 flex flex-row">
          ...
          <div className="w-1/2 md:w-3/5">
            <p className="text-gray-500">
              <span className="text-[#91c561]">{localize('com_files_kb_hours_placeholder')}</span>
              &nbsp; {localize('com_files_free_until_placeholder')}
            </p>
          </div>
        </div>
        <div className="mt-3 flex flex-row">
